...
# # ===Pagina de Cadastro de Cartões de Crédito =====================================================================================
# # Classe Cartão de Crédito
# class CartaoCredito:
#     def __init__(self, nome, fechamento, vencimento):
#         self.nome = nome.strip()
#         self.fechamento = fechamento
#         self.vencimento = vencimento

#     def salvar(self, caminho_banco):
#         with sqlite3.connect(caminho_banco) as conn:
#             conn.execute("""
...
#             else:
#                 try:
#                     cartao = CartaoCredito(nome_cartao, fechamento, vencimento)
