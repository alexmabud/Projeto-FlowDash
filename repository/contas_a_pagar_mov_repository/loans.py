...
- Este mixin é combinado com `BaseRepo` na classe final
  (`ContasAPagarMovRepository`), que fornece utilidades como
...
class LoansMixin(object):
    ...
    def _label_emprestimo(self, row: Dict[str, Any]) -> str:
        """
